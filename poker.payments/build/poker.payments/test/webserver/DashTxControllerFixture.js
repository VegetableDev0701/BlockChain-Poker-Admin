...
const dash_tx_controller_1 = require("../../src/webserver/dash-tx.controller");
const ISecureDataRepository_1 = require("../../src/repository/ISecureDataRepository");
const DashCoreBlockService_1 = require("../../src/services/DashCoreBlockService");
...
describe('DashTxControllerFixture', () => {
    ...
    beforeEach(() => {
        ...
        repository.getCurrencyConfig = (currency) => Promise.resolve(currencyConfig);
        paymentProcessor = jssubstitute_1.default.for({ sendMessage: () => { } });
        dashCoreBlockService = jssubstitute_1.default.for(new DashCoreBlockService_1.DashCoreBlockService(repository));
        controller = new dash_tx_controller_1.DashTxController(repository, paymentProcessor, dashCoreBlockService);
    ...
    it('tx is sent to PaymentProcessor', async () => {
        repository.getAddressInfoByAddress = (address) => Promise.resolve(new AddressInfo_1.AddressInfo());
        ...
        let args = paymentProcessor.argsForCall('sendMessage', 0)[0];
...
//# sourceMappingURL=DashTxControllerFixture.js.map